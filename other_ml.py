...
def main():
    ...
    try:
        ...
        while parse_pt_states(robot.getPrimitiveStates(), "reachedTarget") != "1":
            time.sleep(1)
        robot.getRobotStates(robot_states)
        print("precatch",robot_states.tcpPoseDes)
        print("precatchjoint",robot_states.q)
        ...
        ax.set_ylabel('y')
        ax.set_zlabel('z')
        plt.savefig('trajectory_movel.png')
        plt.show()
