...
def main():
    ...
    catch = [0.507490, -0.091361, 0.481320, -0.886, -179.512, 128.808]
    ...
    try:
        ...
        gripper.move(0.0125, 0.003, 30)
        #######################################HERE############################################
        q = [-10.99, -10.53, -21.30, 71.14, 6.07, -8.95, -8.99]
        for i in range(len(q)):
            q[i] = q[i]*np.pi/180
        print(q)
        target_place=np.array([0.507490, -0.091361, 0.506778])
        target_orient=np.array([0.008812650106847286, 0.9018133282661438, -0.4320356547832489, 0.0005002951365895569])
